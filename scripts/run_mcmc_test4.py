...
def main():
    parser = argparse.ArgumentParser(
        description="MCMC baselines for Test 4 (joint r/τ estimation)"
    )
    ...
    # Pre-compute CAMB spectra (with FITS cache — include nside in filename)
    from astropy.io import fits as pf

    camb_cache = os.path.join(results_dir, f"test4_camb_spectra_nside{nside}.fits")
